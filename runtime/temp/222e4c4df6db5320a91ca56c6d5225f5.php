            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form">
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 数据组 </label>
                  <div class="col-sm-9">
                    <input name="type" type="text" class="col-xs-10 col-sm-5" placeholder="请填写数据组" value="<?php echo $info['type']; ?>" <?php if(isset($info['type'])): ?>readonly<?php endif; ?> />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 数据名称 </label>
                  <div class="col-sm-9">
                    <input name="key" type="text" class="col-xs-10 col-sm-5" placeholder="此处填写数据名称" value="<?php echo $info['key']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 数据值 </label>
                  <div class="col-sm-9">
                    <input name="value" type="text" class="col-xs-10 col-sm-5" placeholder="此处填写数据值" value="<?php echo $info['value']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right">启用状态</label>
                  <div class="col-sm-9">
                    <div class="radio" style="float:left">
                      <label>
                        <input name="state" type="radio" class="ace" value="1" <?php if($info['state'] == '1'): ?>checked<?php endif; ?> >
                        <span class="lbl"> 启用</span> </label>
                    </div>
                    <div class="radio" style="float:left">
                      <label>
                        <input name="state" type="radio" class="ace" value="0" <?php if($info['state'] == '0'): ?>checked<?php endif; ?>>
...
$('a[href="/Admin/Dict/index"]').parents().filter('li').addClass('open active');
