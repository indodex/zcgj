            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="title" type="text" class="col-xs-10 col-sm-5" placeholder="请填写中文新闻标题" value="<?php echo $news['title']; ?>" />
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 新闻标题(En) </label>
                  <div class="col-sm-9">
                    <input name="en_title" type="text" class="col-xs-10 col-sm-5" placeholder="请填写英文新闻标题" value="<?php echo $news['en_title']; ?>" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 col-lg-5" style="padding-right: 0px;">
                  	<script id="container" name="content" text="text/plain"><?php echo $news['content']; ?></script>
                	</div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 新闻内容(En) </label>
                  <br>
                  <div class="col-sm-10 col-lg-5" style="padding-right: 0px;">
                  	<script id="en_container" name="en_content" text="text/plain"><?php echo $news['en_content']; ?></script>
                	</div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="radio">
											<label>
												<input name="state" type="radio" class="ace status_radio" value='1' checked='checked' />
												<span class="lbl"> 显示</span>
											</label>
										</div>
										<div class="radio">
											<label>
												<input name="state" type="radio" class="ace status_radio" value='2' />
                ...
                <div class="clearfix form-actions">
                  ...
                  <input name="id" class="hidden" type="text" value="<?php echo $news['id']; ?>">
