    ...
    <div class="main-content-inner"> 
      ...
      <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li> <a href="<?php echo url('group'); ?>">用户组管理</a> </li>
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> <?php echo $pagename; ?> <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;" href="<?php echo url('group'); ?>"><img src='/static/ace/images/back.png'/>&nbsp;返&nbsp;回&nbsp;</a></h1>
        </div>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form">
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 用户组名称 </label>
                  <div class="col-sm-9">
                    <input name="title" type="text" class="col-xs-10 col-sm-5" placeholder="此处填写用户组名称" value="<?php echo $info['title']; ?>" />
                  </div>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right"> 用户组描述 </label>
                  <div class="col-sm-9">
                    <input name="description" type="text" class="col-xs-10 col-sm-5" placeholder="此处备注用户组用途" value="<?php echo $info['description']; ?>" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="radio">
											<label>
												<input name="status" type="radio" class="ace status_radio" value='1' <?php if($info['status'] == 1): ?>checked='checked'<?php endif; ?> />
												<span class="lbl"> 启用</span>
											</label>
										</div>
										<div class="radio">
											<label>
												<input name="status" type="radio" class="ace status_radio" value='2' 
												<?php
...
$(".form-post").find('button:submit').click(function() {
	$.post("<?php echo url('add_group'); ?>", $(".form-post").serialize()).success(function(data) {
