    ...
    <div class="main-content-inner"> 
      ...
      <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li> <a href="<?php echo url('index'); ?>">商品分类</a> </li>
            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input name="name" type="text" class="col-xs-10 col-sm-5" placeholder="请填写分类名" value="<?php echo $class['name']; ?>" />
                  </div>
                </div>
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                  	<input name="id" class="hidden" type="text" value="<?php echo $class['id']; ?>">
