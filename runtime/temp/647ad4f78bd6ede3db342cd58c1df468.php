          ...
          <div class="row">
            <div class="col-xs-12">
              <form class="form-horizontal form-post-vou" role="form">
                ...
                <?php if(is_array($finance['vou']) || $finance['vou'] instanceof \think\Collection || $finance['vou'] instanceof \think\Paginator): $i = 0; $__LIST__ = $finance['vou'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	                <div class="form-group">
	                  <label class="col-sm-3 control-label no-padding-right"> <?php echo $vo['name']; ?> </label>
	                  <div class="col-sm-9">
	                    <input name="<?php echo $vo['vid']; ?>" type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $vo['name']; ?>" value='<?php echo $vo['number']; ?>'/>
	                  </div>
	                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                  	<input name="uid" class="hidden" type="text" value="<?php echo $uid; ?>" />
          ...
          <div class="row">
            <div class="col-xs-12">
              <form class="form-horizontal form-post-bouns" role="form">
                ...
                <?php if(is_array($finance['bouns']) || $finance['bouns'] instanceof \think\Collection || $finance['bouns'] instanceof \think\Paginator): $i = 0; $__LIST__ = $finance['bouns'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	                <div class="form-group">
	                  <label class="col-sm-3 control-label no-padding-right"> <?php echo $vo['name']; ?> </label>
	                  <div class="col-sm-9">
	                    <input name="<?php echo $vo['bouns_type']; ?>" type="text" class="col-xs-10 col-sm-5" placeholder="<?php echo $vo['name']; ?>" value='<?php echo $vo['bouns_number']; ?>'/>
	                  </div>
	                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="space-4"></div>
...
$(".form-post-vou").find('button:submit').click(function() {
  $.post("<?php echo url('mod_voucher'); ?>", $(".form-post-vou").serialize()).success(function(data) {
...
$(".form-post-bouns").find('button:submit').click(function() {
  $.post("<?php echo url('mod_bouns'); ?>", $(".form-post-bouns").serialize()).success(function(data) {
