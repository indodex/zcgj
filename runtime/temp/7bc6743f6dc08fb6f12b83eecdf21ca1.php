            ...
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="display_box"><?php echo $shop['contact']; ?></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="display_box"><?php echo $shop['contact_file']; ?></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <div class="display_box"><?php echo $shop['business']; ?></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <div class="display_box"><?php echo $shop['tel']; ?></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <div class="display_box"><?php echo $shop['address']; ?></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                     <div class="display_box"><?php echo $shop['create_time']; ?></div>
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                       	<img width="234px" height="153px" src='<?php echo $shop['license']; ?>' />
                    </div>
                </div>
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                    <?php if($shop['examine'] == '1'): ?>
                    <a class="btn btn-danger" href="javascript:void(0);" onclick="do_examine(<?php echo $shop['id']; ?>,<?php echo $shop['uid']; ?>,3)"> <i class="ace-icon fa fa-check bigger-110"></i> 审核不通过 </a>&nbsp;&nbsp;
                    <a class="btn btn-info" href="javascript:void(0);" onclick="do_examine(<?php echo $shop['id']; ?>,<?php echo $shop['uid']; ?>,2)"> <i class="ace-icon fa fa-check bigger-110"></i> 审核通过 </a>
                    <?php endif; if($shop['examine'] == '3'): ?>
                    <a class="btn btn-info" href="javascript:void(0);" onclick="do_examine(<?php echo $shop['id']; ?>,<?php echo $shop['uid']; ?>,2)"> <i class="ace-icon fa fa-check bigger-110"></i> 审核通过 </a>
                    <?php endif; ?>
                  </div>
                </div>
...
function do_examine(id,uid,examine){
	layer.confirm('确定要执行审核吗？',{
		...
		$.post('<?php echo url("shop"); ?>',{id:id,uid:uid,examine:examine}).success(function(data){
			if(data.code == 0){
