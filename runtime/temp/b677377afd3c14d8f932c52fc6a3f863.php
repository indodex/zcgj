    ...
    <div class="main-content-inner"> 
      ...
      <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li> <a href="<?php echo url('preferential'); ?>">优惠专区</a> </li>
      ...
      <div class="page-content">
        <div class="page-header">
          <h1> <?php echo $pagename; ?> <a class="btn btn-sm btn-success" style="float:right; margin-right:10px;" href="<?php echo url('preferential'); ?>"><img src='/static/ace/images/back.png'/>&nbsp;返&nbsp;回&nbsp;</a></h1>
        </div>
          <!-- 添加用户 -->
          <div class="row">
            <div class="col-xs-12">
              <form class="form-horizontal form-post" role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                	...
                	<div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
	                  <input type="text" class="form-control" readonly placeholder="请上传这里商品轮播" value="<?php echo $goods['picture']; ?>" /><br />
	                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                        ...
                        <img name ="detail_pic" width="200px" height="500px"  hidden="" id="detail_pic_view" <?php if(isset($goods['detail_pic'])): ?>src='<?php echo $goods['detail_pic']; ?>' style='display:inline;'<?php endif; ?> />
                    </div>
                    <div class="col-sm-2 col-lg-2" style="padding-left: 0px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 col-lg-3" style="padding-right: 0px;">
                        ...
                        <img name ="service_pic" width="200px" height="500px"  hidden="" id="service_pic_view" <?php if(isset($goods['service_pic'])): ?>src='<?php echo $goods['service_pic']; ?>' style='display:inline;'<?php endif; ?> />
                    </div>
                    <div class="col-sm-2 col-lg-2" style="padding-left: 0px;">
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                  	...
                  	<input id='shop_id' name='shop_id' type='hidden' value='<?php echo $shop_id; ?>' />
...
var shop_id = $('#shop_id').val();
	var uploadInst = upload.render({
    elem: '#picture_upload'
    ,url: "<?php echo url('Shop/upload_pics'); ?>"
    ,data: {type: 'shop',shop_id:shop_id}
    ,multiple: true
    ,done: function(res){
...
<!-- 上传单图片 -->
<!--<script src="/ueditor1433/ueditor.config.js" type="text/javascript"></script>
<script src="/ueditor1433/ueditor.all.min.js" type="text/javascript"></script>
<script src="/ueditor1433/lang/zh-cn/zh-cn.js" type="text/javascript" charset="utf-8" ></script>
<script style="display:none;" type="text/plain" id="input_editor1" ></script>
<script type="text/javascript">
// 商品轮播图
//弹出图片上传的对话框
var url = "<?php echo url('Shop/upload_pics'); ?>";
//实例化编辑器
...
function upImage1(){
    upload_editor1.ready(function(){
        ...
        upload_editor1.addListener('beforeInsertImage', function (t,arg){
            ...
            $("input[name=picture]").val(src);
        });
    });
    //弹出图片上传的对话框
    var myImage = upload_editor1.getDialog("insertimage");
    myImage.open();
}
</script>-->
...
$(".form-post").find('button:submit').click(function() {
  ...
  $.post("<?php echo url('add_preferential_goods'); ?>", $(".form-post").serialize()).success(function(data) {
