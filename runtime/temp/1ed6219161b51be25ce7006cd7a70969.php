              ...
              <form class="form-horizontal form-post" role="form">
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                  	<input name="id" class="hidden" type="text" <?php if(isset($id)): ?>value="<?php echo $info['id']; ?>"<?php endif; ?>>
