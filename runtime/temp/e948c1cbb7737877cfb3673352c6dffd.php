...
<script type="text/javascript">
	$('a[href="/Admin/Config/info"]').parents().filter('li').addClass('open active');
</script>
<script type="text/javascript">
