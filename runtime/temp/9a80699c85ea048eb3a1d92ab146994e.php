              ...
              <form class="form-horizontal form-post" role="form">
                ...
                <div class="clearfix form-actions">
                  <div class="col-md-offset-3 col-md-9">
                  	<input id='detail_id' name="uid" class="hidden" type="text" value="<?php echo $uid; ?>" />
...
$(".form-post").find('button:submit').click(function() {
  $.post("<?php echo url('mod_voucher'); ?>", $(".form-post").serialize()).success(function(data) {
