...
<script type="text/javascript">
	$('a[href="/Admin/Admin/rule"]').parents().filter('li').addClass('open active');
</script>
<script type="text/javascript">
  jQuery(function($) { 
    //更改显示状态
